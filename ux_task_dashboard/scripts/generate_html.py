                        ...
                        <div class="pb-10 border-b border-stone-900/60">
                            <div class="space-y-4">
                                ...
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal">
                                    I tried to review the current FPV app as carefully and deeply as possible throughout this project. My goal was not simply to prepare a screen-based estimation, but to evaluate the product more holistically from both UI and operational UX perspectives in order to build a more realistic redesign roadmap.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal">
                                    Having the opportunity to prepare a new project proposal for a brand I previously worked with was also personally valuable to me. Because of this, the resulting proposal & estimation structure were prepared thoughtfully, and according to my "own quality standards" rather than being rushed or simplified.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal">
                                    Throughout the process, I tried to evaluate not only the existing screen structures, but also the workflows, operational needs, and structural areas that may naturally evolve during the redesign process.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal">
                                    A real estate agent’s role is often much more meaningful than simply selling a property. In many cases, they are helping people who are trying to build a new life, move into a new phase of life, or find the right living space for themselves and their families. Because of this, they naturally want to present options to their clients in the clearest, most trustworthy, and most professional way possible.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal">
                                    This is where the FPV platform becomes especially valuable. Your services help real estate agents deliver that experience to their own clients.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal">
                                    For this reason, one of the most important goals for me throughout the redesign process is not only improving functionality, but also helping transform the platform into an experience that better reflects the value of the work real estate agents do; a platform where they can feel more comfortable, more confident, more professional, and more valued while using it.
                                </p>
                            </div>
                        </div>
