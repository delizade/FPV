            ...
            <div id="project-scope-content" class="hidden border-t border-[#1d1b20] p-6 md:px-[73px] bg-black/15 rounded-b">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <aside class="hidden lg:block lg:col-span-1">
                        <!-- Sticky Header Box -->
                        <div class="glass-effect pt-[16px] px-4 rounded-t sticky top-[62px] z-30 border border-brand-900/10 border-b-0 shadow-lg shadow-black/20 bg-[#111012]/95 backdrop-blur-md">
                        ...
                        <!-- Scrollable Content Box (scrolls with window scroll under the header) -->
                        <div class="glass-effect pt-4 pb-6 px-4 rounded-b border border-brand-900/10 border-t-0 shadow-xl shadow-black/20 relative z-20" id="sidebar-tree">
