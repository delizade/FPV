                    ...
                    <div class="space-y-12">
                        ...
                        <div class="pb-10 border-b border-stone-900/60">
                            <div class="space-y-4">
                                ...
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal text-pretty">
                                    HAVING THE OPPORTUNITY TO PREPARE A NEW PROJECT PROPOSAL FOR A BRAND I PREVIOUSLY WORKED WITH WAS ALSO PERSONALLY MEANINGFUL TO ME. Because of this, the resulting proposal and estimation structure were prepared thoughtfully and according to my own quality standards rather than being rushed or overly simplified.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal text-pretty">
                                    A real estate agent’s role is often much more meaningful than simply selling a property. In many cases, they are helping people who are trying to build a new life, move into a new phase of life, or find the right living space for themselves and their families. Because of this, they naturally want to present options to their clients in the clearest and most professional way possible. This is where the FPV platform becomes especially important. Your services help real estate agents deliver a stronger and more reliable experience to their own clients.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal text-pretty">
                                    For this reason, one of the most important goals for me throughout the redesign process is not only improving functionality, but also helping transform the platform into an experience that better reflects the importance of the work real estate agents do — a platform where they can feel more comfortable, more confident, more professional, and more appreciated while using it.
                                </p>
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal text-pretty">
                                    I tried to review the current FPV app as carefully as possible throughout this project. My goal was not simply to prepare a screen-based estimation, but to evaluate the product more holistically from both UI and operational UX perspectives while also considering workflows, operational needs, and structural areas that may naturally evolve throughout the redesign process in order to build a more realistic redesign roadmap.
                                </p>
                            </div>
                        </div>
