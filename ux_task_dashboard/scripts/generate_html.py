...
<body class="min-h-screen text-slate-200">
    ...
    <div id="hero-banner" class="max-w-[1440px] mx-auto w-full h-auto min-h-[480px] md:h-[563px] bg-[#151418] relative overflow-hidden border-b border-stone-800/40 mb-4 select-none rounded-b font-sans">
        <!-- Background image -->
