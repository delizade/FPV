    ...
    <div class="max-w-[1440px] mx-auto py-6 w-full px-0 sm:px-0 lg:px-0">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <main class="col-span-full lg:col-span-3">
                ...
                <div id="right-stats-bar" class="sticky top-[62px] z-20 bg-transparent pt-[30px] pb-0 -ml-6 pl-6 mb-5 -mt-6 transition-all duration-300">
                    <!-- DESKTOP LAYOUT -->
                    <div id="stats-inner-desktop" class="hidden sm:flex items-center justify-between px-2 pb-1.5 border-b border-stone-900/60">
                    ...
                    <!-- MOBILE LAYOUT -->
                    <div id="stats-inner-mobile" class="flex sm:hidden items-center justify-between px-2 pb-1.5 border-b border-stone-900/60">
