    ...
    <div class="max-w-[1440px] mx-auto py-6 w-full px-0 sm:px-0 lg:px-0">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <main class="col-span-full lg:col-span-3">
                ...
                <div id="right-stats-bar" class="sticky top-[62px] z-20 bg-transparent pt-[28px] pb-[10px] -mx-6 px-6 border-b border-stone-900/60 mb-5 -mt-6 transition-all duration-300">
                    <!-- DESKTOP LAYOUT -->
