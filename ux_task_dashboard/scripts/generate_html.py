        ...
        <div class="border border-[#221f24] bg-[#111012] rounded overflow-hidden shadow-2xl transition-all duration-300">
            ...
            <div id="project-proposal-content" class="hidden border-t border-[#1d1b20] p-6 md:py-16 md:px-[73px] bg-black/15">
                <div class="max-w-[960px] space-y-16 text-left">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 border-t border-stone-900/80">
                        ...
                        <div class="bg-[#151418] border border-brand-500/20 border-l-4 border-l-brand-500 rounded-lg p-6 flex flex-col justify-between shadow-xl relative overflow-hidden">
                            <div class="absolute right-0 top-0 w-16 h-16 bg-brand-500/5 rounded-bl-full flex items-center justify-center">
                                <i class="fa-solid fa-star text-[10px] text-brand-500/30"></i>
                            </div>
                            <div>
                                <h4 class="text-xs font-bold text-brand-400 tracking-wider uppercase mb-4 font-sans flex items-center gap-1.5">
                            ...
                            <div class="mt-8 pt-4 border-t border-stone-900/60 flex items-baseline justify-between">
                                <span class="text-xs text-slate-250 font-bold">Final Fixed Budget</span>
                                <span class="text-2xl font-black text-slate-100 font-mono">$10,000</span>
                            </div>
                        </div>
