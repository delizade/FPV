                    ...
                    <div class="space-y-12">
                        ...
                        <div class="pb-10 border-b border-stone-900/60">
                            <div class="space-y-4">
                                ...
                                <p class="text-sm md:text-base text-[#C6C1BC] leading-[175%] font-normal text-pretty">
                                    This is where the FPV platform becomes especially valuable. Your services help real estate agents deliver a stronger, more reliable, and more professional experience to their own clients.
                                </p>
                            </div>
                        </div>
