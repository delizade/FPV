...
<body class="min-h-screen text-slate-200">
    ...
    <div class="max-w-[1440px] mx-auto w-full h-auto min-h-[480px] md:h-[563px] bg-[#151418] relative overflow-hidden border-b border-stone-800/40 mb-8 select-none rounded-none font-sans">
        <!-- Background image -->
        ...
        <div class="hidden md:block">
            ...
            <div class="absolute right-[37px] bottom-[10px] text-white/25 text-[10px] font-light font-sans flex items-center gap-1.5 select-none">
